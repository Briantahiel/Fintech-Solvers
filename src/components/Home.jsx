    ...
    <>
          ...
          <main className="main-content">
            ...
            <section>
              ...
              <p>
                ...
                conexiones valiosas entre diversos atributos, como los detalles
                de las transacciones, la metadata asociada, las categorías
                específicas y los indicadores de anomalía y fraude. Esta
                integración de información nos permitió profundizar en las
                relaciones entre estas variables y revelar correlaciones
            ...
            <section>
              ...
              <p>
                ...
                fraude, desarrollamos y desplegamos modelos de machine learning
                de vanguardia para identificar y clasificar transacciones
                sospechosas o fraudulentas. La implementación de algoritmos
                avanzados y técnicas de aprendizaje automático nos permitió
                discernir patrones sutiles y detectar comportamientos anómalos
            ...
            <section>
              ...
              <p>
                ...
                ajuste del modelo, donde refinamos continuamente los parámetros
                y evaluamos el rendimiento del modelo en datos de prueba no
                observados. La validación cruzada rigurosa y el análisis
                exhaustivo de métricas de rendimiento garantizaron la fiabilidad
                y la robustez de nuestros modelos en una variedad de escenarios
            ...
            <section>
              ...
              <p>
                ...
                dentro de las transacciones financieras. Basándonos en nuestros
                hallazgos, formulamos recomendaciones específicas para
                fortalecer los sistemas de detección y prevención de fraudes,
                con el objetivo de proteger los activos financieros y preservar
                la confianza del cliente. Además, destacamos la importancia de
                la educación y la concienciación continua sobre la
                ciberseguridad y las mejores prácticas en la gestión de riesgos
                financieros, como parte integral de cualquier estrategia
                efectiva de prevención de fraudes.
              </p>
            </section>
          </main>
        </div>
      ...
      <div className="container">
        <div className="section">
          <h1 className="titles">
            Modelo de Machine Learning para Detección de Fraudes:
          </h1>
          <div className="borde-inferior"></div>
          <br />
          <p>
            El objetivo de este modelo es identificar transacciones fraudulentas
            dentro de un conjunto de datos de transacciones financieras. Para
            lograr esto, se emplean algoritmos de machine learning que son
            capaces de aprender patrones y comportamientos anómalos a partir de
            datos históricos.
          </p>
        </div>
        ...
        <div className="section">
          ...
          <ol>
            ...
            <li>
              ...
              adicionales sobre cada transacción, como la fecha y hora en que se
              realizó y el ID del comerciante.
            </li>
            <li>
              <strong>Anomaly Score:</strong> Ofrece una puntuación de anomalía
              para cada transacción, lo que indica el nivel de desviación de la
              norma.
            </li>
            <li>
              <strong>Transaction Category Labels:</strong> Define la categoría
              de cada transacción, lo que puede ser útil para identificar
              patrones específicos de fraudes en ciertas categorías.
            </li>
            <li>
            ...
            <li>
              <strong>Account Activity:</strong> Detalles sobre la actividad de
              la cuenta de los clientes, como su saldo y fecha del último inicio
              de sesión.
            </li>
          </ol>
        </div>
        ...
        <div className="section">
          ...
          <ol>
            ...
            <li>
              <strong>Selección de Características:</strong> Se identifican las
              características más relevantes para la detección de fraudes, lo
              que puede implicar el análisis de correlaciones y la selección de
              características basada en la importancia.
            </li>
            <li>
              <strong>Entrenamiento del Modelo:</strong> Se utilizan algoritmos
              de machine learning, como árboles de decisión, bosques aleatorios
              o métodos de aprendizaje no supervisado, para entrenar el modelo
              utilizando los datos históricos. Durante este proceso, el modelo
              aprende los patrones normales de comportamiento y puede
              identificar anomalías.
            </li>
            <li>
              <strong>Evaluación del Modelo:</strong> Se evalúa el rendimiento
              del modelo utilizando métricas como la precisión, la sensibilidad
              y la especificidad para evaluar la capacidad de discriminación del
              modelo.
            </li>
          </ol>
        </div>
        ...
        <div className="section">
          ...
          <p>
            Utilizando el modelo entrenado, se pueden identificar transacciones
            sospechosas o fraudulentas en tiempo real. El modelo analiza las
            características de cada transacción y las compara con los patrones
            aprendidos durante el entrenamiento. Si una transacción se desvía
            significativamente de los patrones normales, se marca como
            sospechosa y se requiere una revisión adicional por parte del equipo
            de seguridad.
          </p>
        </div>
      </div>
      ...
      <div className="container">
        <div className="section">
          ...
          <ol>
            <li>
              ...
              conjunto de datos de Transacciones y Metadata están estrechamente
              relacionados, ya que la Metadata proporciona información adicional
              sobre cada transacción, como la fecha, la hora y el comerciante
              involucrado. Esta relación puede ser fundamental para identificar
              patrones temporales o comportamientos inusuales asociados con
              ciertos comerciantes o momentos del día.
            </li>
            <li>
              <strong>
              ...
              Al analizar la relación entre las categorías de transacciones y el
              indicador de fraude, podemos identificar si ciertas categorías
              están más asociadas con actividades fraudulentas. Por ejemplo,
              podría haber una mayor incidencia de fraudes en ciertas
              categorías, como las transacciones en línea o las transacciones de
              viaje.
            </li>
            <li>
              <strong>
                Impacto de la Actividad del Cliente en la Detección de Fraudes:
              </strong>{" "}
              ...
              comportamiento de los clientes que podrían estar relacionados con
              actividades fraudulentas. Por ejemplo, ciertos patrones de
            ...
            <li>
              <strong>Anomalías en los Montos de las Transacciones:</strong> El
              conjunto de datos de Amount Data puede revelar anomalías en los
              montos de las transacciones que podrían indicar posibles casos de
              fraude. Por ejemplo, transacciones inusualmente grandes o pequeñas
              podrían ser indicativas de actividades fraudulentas, especialmente
              si no coinciden con el historial de transacciones del cliente.
            </li>
          </ol>
        </div>
        ...
        <div className="section">
          ...
          <p>
            ...
            incluyendo la calidad de los datos, la disponibilidad de información
            relevante y la capacidad de cada conjunto de datos para proporcionar
            insights significativos. Sin embargo, los conjuntos de datos de
            Transacciones, Metadata y Suspicious Activity parecen ser
            especialmente prometedores debido a su capacidad para proporcionar
            información detallada sobre las transacciones individuales, la
            actividad del cliente y los patrones de comportamiento anómalos.
          </p>
        </div>
  ...
  <div className="carousel-inner">
    <div className="carousel-item active">
      <div style={{ marginBottom: "160px" }}>
        <img src={kevin} className="d-block w-25" alt="Kevin Castellano" />
      </div>
      <div className="carousel-caption d-md-block">
        <h6>Kevin Castellano - <span>Data Engineer</span></h6>
      </div>
    </div>
    <div className="carousel-item">
      ...
      <div className="carousel-caption d-md-block">
        <h6>Brian Gómez - <span>Data Scientist</span></h6>
      </div>
    </div>
    <div className="carousel-item">
      <div style={{ marginBottom: "160px" }}>
        <img src={marcos} className="d-block w-25" alt="Marcos Miño" />
      </div>
      <div className="carousel-caption d-md-block">
        <h6>Marcos Miño - <span>Data Analyst</span></h6>
      </div>
    </div>
    <div className="carousel-item">
      <div style={{ marginBottom: "160px" }}>
        <img src={veronica} className="d-block w-25" alt="Verónica Moroni" />
      </div>
      <div className="carousel-caption d-md-block">
        <h6>Verónica Moroni - <span>Analyst BI</span></h6>
      </div>
    </div>
    <div className="carousel-item">
      <div style={{ marginBottom: "160px" }}>
        <img src={diego} className="d-block w-25" alt="Diego Sanabria" />
      </div>
      <div className="carousel-caption d-md-block">
        <h6>Diego Sanabria - <span>Machine Learning Developer</span></h6>
      </div>
    </div>
    <div className="carousel-item">
      <div style={{ marginBottom: "160px" }}>
        <img src={mayra} className="d-block w-25" alt="Mayra Sierra" />
      </div>
      <div className="carousel-caption d-md-block">
        <h6>Mayra Sierra - <span>Data Analyst</span></h6>
      </div>
    </div>
  </div>
  <button
